              ...
              <View
                ...
                <View>
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={{fontSize: 14, color: '#999', fontWeight: '400'}}>
                      {handleAddress(item?.uid ?? '')}
                    </Text>
                    <Image
                      style={{
                    ...
                    onPress={async () => {
                      ...
                      try {
                        ...
                        const sharedSecret = globalThis.wallet.signingKey
                          .computeSharedSecret(
                            Buffer.from(group.pub.substring(2), 'hex'),
                          )
                          .substring(4);
                        const groupPri = quickAes.De(
                          encInfo.enc_pri,
                          sharedSecret,
                        );
                        const groupKey = quickAes.De(
                          encInfo.enc_key,
                          sharedSecret,
                        );
                        ...
                        const userSharedSecret = groupWallet.signingKey
                          .computeSharedSecret(
                            Buffer.from(user.pub_key.substring(2), 'hex'),
                          )
                          .substring(4);
                        const userGroupEncKey = quickAes.En(
                          groupKey,
                          userSharedSecret,
                        );
